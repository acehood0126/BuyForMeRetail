...
const Sidebar = ({ current }) => {
  return (
    <div className="w-full h-full transition ease-linear lg:w-[200px] sm:w-[60px] md:block hidden text-[14px] bg-[#06163a] z-10">
      <div className="h-[50px]">
        <Link
          to="/dashboard"
          className="absolute lg:mt-[20px] lg:ml-[23px] mt-[10px] ml-[13px]"
        >
